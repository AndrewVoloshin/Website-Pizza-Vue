...
h1 {
  animation: lighting 0.5s infinite;
...
.preloader__img {
  ...
  height: auto;
  margin-right: 20px;
  animation: lighting 0.5s infinite, move 2s infinite;
}
