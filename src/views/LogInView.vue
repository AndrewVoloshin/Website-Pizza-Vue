<template>
  <div class="register">
    <div class="register__container">
      <app-title :titleText="'login'" class="title" />
      <form class="register__content" @submit.prevent="onSubmit">
        ...
        <div class="alert" v-if="$v.$anyError" >
          ...
          <strong v-else>There is no user record corresponding to this identifier. The user may have been deleted.</strong>
        </div>
        <p class="content__text"> Not yet registered?
          <router-link class="content__link" tag="a" to="/register">Register</router-link>
        </p>
        <button
        type="submit"
